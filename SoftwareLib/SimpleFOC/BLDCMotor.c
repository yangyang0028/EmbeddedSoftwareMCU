...
void setPhaseVoltage(float Uq, float Ud, float angle_el)
{
	...
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, (int)(Ta * 5000));
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_2, (int)(Tb * 5000));
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_3, (int)(Tc * 5000));
}
/******************************************************************************/
float velocityOpenloop(float target_velocity)
{
